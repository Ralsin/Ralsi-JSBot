module.exports = {
    name: 'onMessage',
    execute(message, sql, said, bot, MessageEmbed, bugnanas){
        ...
        if(message.content === '<@!793504895738314782>' || message.content === `@${bot.user.tag}`){bot.commands.get('abot').execute(message, MessageEmbed, bot)}    
    }
}